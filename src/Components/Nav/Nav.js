        ...
        <div className={styles.Nav}>
          ...
          <div>
            <Link to={'/video'} className={styles.Link} tabIndex="0">
              <svg className={styles.navIconSVG} viewBox="0 0 1024 1024" height="1em" width="1em">
                <path d='M 912 302.3 L 784 376 V 224 c 0 -35.3 -28.7 -64 -64 -64 H 128 c -35.3 0 -64 28.7 -64 64 v 576 c 0 35.3 28.7 64 64 64 h 592 c 35.3 0 64 -28.7 64 -64 V 648 l 128 73.7 c 21.3 12.3 48 -3.1 48 -27.6 V 330 c 0 -24.6 -26.7 -40 -48 -27.7 Z M 712 792 H 136 V 232 h 576 v 560 Z m 176 -167 l -104 -59.8 V 458.9 L 888 399 v 226 Z M 208 360 h 112 c 4.4 0 8 -3.6 8 -8 v -48 c 0 -4.4 -3.6 -8 -8 -8 H 208 c -4.4 0 -8 3.6 -8 8 v 48 c 0 4.4 3.6 8 8 8 Z'/>
              </svg>  
              video  
            </Link>
          </div>
